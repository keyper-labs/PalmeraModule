...
contract KeyperModuleHelperV2 is Test, SignDigestHelper, SignersHelper {
    ...
    function initHelper(KeyperModuleV2 _keyper, uint256 numberOwners) public {
        keyper = _keyper;
        ...
        returns (address)
    {
        ...
        keyper = new KeyperModuleV2(masterCopy, safeFactory, rolesAuthority);
